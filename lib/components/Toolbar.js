...
var _ToolbarConfig = require('./ToolbarConfig');

var _StyleButton = require('./StyleButton');

var _StyleButton2 = _interopRequireDefault(_StyleButton);

var _PopoverIconButton = require('./PopoverIconButton');
...
var _getEntityAtCursor2 = require('../lib/getEntityAtCursor');
...
var Toolbar = function (_Component) {
  ...
  _createClass(Toolbar, [{
    ...
    value: function render() {
      ...
      var toolbar = this.context.ortTheme.toolbar;

      return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)(css.root, className), style: toolbar },
    ...
    value: function _renderBlockTypeDropdown() {
      ...
      var buttons = _ToolbarConfig.BLOCK_TYPE_DROPDOWN.map(function (type, index) {
    ...
    value: function _renderBlockTypeButtons() {
      ...
      var blockType = this._getCurrentBlockType();
      var buttons = _ToolbarConfig.BLOCK_TYPE_BUTTONS.map(function (type, index) {
        return _react2.default.createElement(_StyleButton2.default, {
          key: String(index),
          active: type.style === blockType,
          label: type.label,
    ...
    value: function _renderInlineStyleButtons() {
      ...
      var buttons = _ToolbarConfig.INLINE_STYLE_BUTTONS.map(function (type, index) {
        return _react2.default.createElement(_StyleButton2.default, {
          key: String(index),
