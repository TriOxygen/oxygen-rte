...
var IconButton = function (_Component) {
  ...
  _createClass(IconButton, [{
    ...
    value: function render() {
      ...
      var otherProps = _objectWithoutProperties(_props, ['className', 'iconName', 'label', 'children', 'isActive']);

      var classes = (0, _classnames2.default)(className, css.root, _defineProperty({}, css.active, isActive));
