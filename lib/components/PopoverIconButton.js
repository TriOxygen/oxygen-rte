...
var PopoverIconButton = function (_Component) {
  ...
  function PopoverIconButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(PopoverIconButton)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this._onSubmit = function () {
      var _this$props;

      (_this$props = _this.props).onSubmit.apply(_this$props, _arguments);
    }, _this._hidePopover = function () {
      if (_this.props.showPopover) {
        var _this$props2;

        (_this$props2 = _this.props).onTogglePopover.apply(_this$props2, _arguments);
      }
